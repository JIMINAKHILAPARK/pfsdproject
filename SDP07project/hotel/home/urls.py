...
urlpatterns = [
    ...
    path('login.html/register.html/', signup , name='home'),
    path('login.html/register.html/login.html/', login_page , name=''),
    path('login.html/register.html/login.html/register.html', signup , name='home'),
    path('hotel-detail/<uid>/', hotel_detail, name="hotel_detail"),
    path('login/', login_page, name='login_page'),
    path('payment/', payment , name='login_page'),
    ...
    path('hotel-detail/<uid>/payment.html', payment , name="hotel_detail"),
]
